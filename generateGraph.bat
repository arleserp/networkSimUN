...
REM java   -classpath dist/NetworkSimulator.jar unalcol.agents.NetworkSim.graphGenerator line 2 
java   -classpath dist/NetworkSimulator.jar unalcol.agents.NetworkSim.graphGenerator foresthubandspoke 100 4
