...
public class NetworkEnvironmentCollection extends Environment {
    ...
    public NetworkEnvironmentCollection(Vector<Agent> _agents, SimpleLanguage _language, Graph<GraphElements.MyVertex, String> gr) {
        super(_agents);
    ...
    public void setAgentsDie(int agentsDie) {
        NetworkEnvironmentCollection.agentsDie = agentsDie;
    }
    ...
    public void increaseAgentsDie() {
        synchronized (NetworkEnvironmentCollection.class) {
            NetworkEnvironmentCollection.agentsDie++;
        }
    }
