...
public class NetworkEnvironmentPheromoneCollection extends NetworkEnvironmentCollection {

    public NetworkEnvironmentPheromoneCollection(Vector<Agent> _agents, SimpleLanguage _language, Graph<GraphElements.MyVertex, String> gr) {
