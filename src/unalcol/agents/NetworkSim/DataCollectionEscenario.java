...
import unalcol.agents.NetworkSim.util.DataCollectionObserver;
 ...
 */
public class DataCollectionEscenario implements Runnable {

    private NetworkEnvironmentCollection world;
...
//    GraphicReportHealingObserver greport;
     ...
     * @return
     */
    DataCollectionEscenario(int pop, float pf) {
        population = pop;
        probFailure = pf;
    ...
    public void init() {
        ...
        graphVisualization = new DataCollectionObserver();
        world = new NetworkEnvironmentPheromoneCollection(agents, languaje, g);
