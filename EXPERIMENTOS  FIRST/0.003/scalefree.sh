...
java  -classpath ../../dist/NetworkSimulator.jar unalcol.agents.NetworkSim.DataCollectionMain load scalefree+sn+4+eta+1+numSt+97.graph 10 0.003 randomMarking scalefree+sn+4+eta+1+numSt+97.loc -1
